...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--job', type=str, default=None, help="unstructured_pruning, filter_pruning, etc.")
        ...
        self.parser.add_argument('--filter_idx', type=int, default=0, help='filter index to prune')
